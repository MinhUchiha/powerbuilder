...
Choose Case ls_column
	...
	Case	"$$HEX4$$c154ee766a75f753$$ENDHEX$$","$$HEX7$$2f63ff664d52c154ee766a75f753$$ENDHEX$$","$$HEX7$$2f63ff668c5fc154ee766a75f753$$ENDHEX$$","$$HEX6$$2375fa51c154ee766a75f753$$ENDHEX$$","$$HEX6$$95626551c154ee766a75f753$$ENDHEX$$","$$HEX6$$fe5bd46bc154ee766a75f753$$ENDHEX$$", &
			...
			"$$HEX6$$e34eff66c154ee766a75f753$$ENDHEX$$", "$$HEX6$$8b95cb59c154ee766a75f753$$ENDHEX$$", "$$HEX6$$427d864ec154ee766a75f753$$ENDHEX$$", "$$HEX5$$505bc154ee766a75f753$$ENDHEX$$", "$$HEX7$$fa516567d89ac154ee766a75f753$$ENDHEX$$", "$$HEX6$$fa57966ec154ee766a75f753$$ENDHEX$$" , &
			"$$HEX6$$36525096c154ee766a75f753$$ENDHEX$$"
		...
		Choose Case	ls_column
			...
			case "$$HEX6$$fa57966ec154ee766a75f753$$ENDHEX$$"
				ldwo_my  = this.object.$$HEX6$$fa57966ec154ee766a75f753$$ENDHEX$$
				ls_moji  = "$$HEX2$$fa57966e$$ENDHEX$$"
			case "$$HEX6$$36525096c154ee766a75f753$$ENDHEX$$"
				ldwo_my  = this.object.$$HEX6$$36525096c154ee766a75f753$$ENDHEX$$
				ls_moji  = "$$HEX2$$36525096$$ENDHEX$$"
		End Choose
	...
	Case	"$$HEX6$$e930a430f330b330fc30c930$$ENDHEX$$", "$$HEX8$$f8764b62e930a430f330b330fc30c930$$ENDHEX$$"
		...
		If ls_column = "$$HEX8$$f8764b62e930a430f330b330fc30c930$$ENDHEX$$" Then
			...
			lstr_bumon.$$HEX3$$745e08670900$$ENDHEX$$= lstr_line.$$HEX2$$745e0867$$ENDHEX$$
			lstr_bumon.$$HEX6$$e8908095b330fc30c9300900$$ENDHEX$$= lstr_line.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$
			pf_get_bumon2(lstr_bumon)
			
			//$$HEX24$$f8764b62e8908095b330fc30c9304c30c24f603063305f308930e8908095b330fc30c930923065518c306a304a305730$$ENDHEX$$
			if  lstr_bumon.$$HEX5$$e89080953a5306520900$$ENDHEX$$= "5" then
				lstr_line.$$HEX8$$e8908095b330fc30c930090009000900$$ENDHEX$$= lstr_line.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$
				lstr_line.$$HEX8$$e55d3458e8908095b330fc30c9300900$$ENDHEX$$= lstr_bumon.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$
			end if	
			
			//$$HEX21$$f8764b62e8908095b330fc30c9304c309395a563603063305f308930e8908095b330fc30c9306a305730$$ENDHEX$$($$HEX6$$e55d3458e890809560305130$$ENDHEX$$)
			if lstr_bumon.$$HEX5$$e89080953a5306520900$$ENDHEX$$= "2" or lstr_bumon.$$HEX5$$e89080953a5306520900$$ENDHEX$$= "4" then
				lstr_line.$$HEX8$$e55d3458e8908095b330fc30c9300900$$ENDHEX$$= lstr_bumon.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$
				lstr_line.$$HEX8$$e8908095b330fc30c930090009000900$$ENDHEX$$= ""
			end if
		...
		If	pf_open_line(lstr_line)	Then
			...
			wf_mod_set(ll_row, ls_moji + "$$HEX6$$e55d3458e89080950d54f079$$ENDHEX$$"	, lstr_line.$$HEX7$$e55d3458e89080950d54f0790900$$ENDHEX$$, 1)
			
			if lstr_line.$$HEX6$$e8908095b330fc30c9300900$$ENDHEX$$<> "" then
				wf_mod_set(ll_Row, ls_moji + "$$HEX5$$e8908095b330fc30c930$$ENDHEX$$"		, lstr_line.$$HEX7$$e8908095b330fc30c93009000900$$ENDHEX$$, 1)
				wf_mod_set(ll_Row, ls_moji + "$$HEX4$$e89080950d54f079$$ENDHEX$$"		, lstr_line.$$HEX7$$e89080950d54f079090009000900$$ENDHEX$$, 1)
			end if
		...
		Choose Case	ls_column
			...
			Case	"$$HEX6$$4851e8908095b330fc30c930$$ENDHEX$$"
				...
				if ls_prog_name	= "MES_J14" then	//$$HEX10$$315c6d6942669395fb79d5521d4f687965519b52$$ENDHEX$$
					...
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[3] = "3"
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[4] = "4"
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[5] = "5"	//	2008.04.24 ADD
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[6] = "6"
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[7] = "7"
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[8] = "8"
				else
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[1] = "1"
					lstr_bumon.$$HEX6$$e89080953a5306524d911752$$ENDHEX$$[2] = "3"
				end if
...
Choose Case	ls_column
	...
	Case	"$$HEX6$$e930a430f330b330fc30c930$$ENDHEX$$", "$$HEX8$$f8764b62e930a430f330b330fc30c930$$ENDHEX$$"
		If ls_prog_name <> "COM_M19" Then	//$$HEX6$$e930a430f330de30b930bf30$$ENDHEX$$
			...
			If ls_column = "$$HEX8$$f8764b62e930a430f330b330fc30c930$$ENDHEX$$" Then
				...
				//$$HEX27$$f8764b62e8908095b330fc30c9304c309395a563fb30c24f603063305f308930e8908095b330fc30c930923065518c306a304a305730$$ENDHEX$$
				if lstr_bumon.$$HEX5$$e89080953a5306520900$$ENDHEX$$= "2" or lstr_bumon.$$HEX5$$e89080953a5306520900$$ENDHEX$$= "4" or lstr_bumon.$$HEX5$$e89080953a5306520900$$ENDHEX$$= "5" then
					lstr_line.$$HEX8$$e8908095b330fc30c930090009000900$$ENDHEX$$= lstr_line.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$
					lstr_line.$$HEX8$$e55d3458e8908095b330fc30c9300900$$ENDHEX$$= lstr_bumon.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$
				end if	
	...
	Case	"$$HEX5$$e8908095b330fc30c930$$ENDHEX$$", "$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$","$$HEX6$$c24fe8908095b330fc30c930$$ENDHEX$$","$$HEX8$$2f63ff664851e8908095b330fc30c930$$ENDHEX$$","$$HEX9$$fa51ab5ee55d3458e8908095b330fc30c930$$ENDHEX$$","$$HEX9$$6551ab5ee55d3458e8908095b330fc30c930$$ENDHEX$$" &
		...
		If (ls_prog_name = "COM_M11" AND ls_column = "$$HEX5$$e8908095b330fc30c930$$ENDHEX$$") = FALSE Then	//$$HEX5$$e8908095de30b930bf30$$ENDHEX$$
			...
			If ls_column = "$$HEX6$$4851e8908095b330fc30c930$$ENDHEX$$" Then		//	2008.04.24 ADD
				wf_mod_set(row, "$$HEX8$$4851e55d3458e8908095b330fc30c930$$ENDHEX$$",	lstr_bumon.$$HEX7$$e55d3458e8908095b330fc30c930$$ENDHEX$$,	1)
			End If
...
------------------------------------------------------------------------------------*/
	Case	"$$HEX1$$745e$$ENDHEX$$", "$$HEX1$$1f67$$ENDHEX$$"
		...
		lb_date_changed = True
/*------------------------------------------------------------------------------------
		$$HEX5$$884e977b745ea65e2000$$ENDHEX$$/ $$HEX3$$884e977b1f67$$ENDHEX$$
------------------------------------------------------------------------------------*/
	Case	"$$HEX4$$884e977b745ea65e$$ENDHEX$$", "$$HEX3$$884e977b1f67$$ENDHEX$$"
		// $$HEX6$$745efb301f670030d653975f$$ENDHEX$$
		If ls_column = "$$HEX4$$884e977b745ea65e$$ENDHEX$$" Then
			ldt_date = Datetime(Date(data))				// $$HEX4$$745ebb30c330c830$$ENDHEX$$
			wf_mod_get(row, "$$HEX3$$884e977b1f67$$ENDHEX$$", ls_ki, 1)			// $$HEX3$$1f67d653975f$$ENDHEX$$
		Else
			wf_mod_get(row, "$$HEX4$$884e977b745ea65e$$ENDHEX$$", ls_date, 4)	// $$HEX3$$745ed653975f$$ENDHEX$$
			ldt_date	= Datetime(Date(ls_date))
			ls_ki	=	data										// $$HEX4$$1f67bb30c330c830$$ENDHEX$$
		End If
		// $$HEX3$$1f673652a15f$$ENDHEX$$
		If ls_ki <> "1" and ls_ki <> "2" Then		// 1:$$HEX3$$0a4e1f672000$$ENDHEX$$2:$$HEX2$$0b4e1f67$$ENDHEX$$
			ls_ki		= "2"		// 2:$$HEX4$$0b4e1f6771624430$$ENDHEX$$
		End If
		// $$HEX26$$535f728a884e977b1f6767306e300067427d0867a65e9230d653975f090008ff1f678b95cb590867a65e0bff15fff630086709ff$$ENDHEX$$
		ldt_date	= Datetime(pf_add_months(Date(pf_get_ki_sta2( ldt_date, ls_ki)), 5))
		// $$HEX11$$0967b9526a30de30b930bf30745e08676b300959db63$$ENDHEX$$
		ls_date		= String(pf_get_master_date(ldt_date))
		
		// $$HEX5$$745e0867bb30c330c830$$ENDHEX$$
		wf_mod_set(row, "$$HEX2$$745e0867$$ENDHEX$$", ls_date, 4)
		lb_date_changed = True
End Choose
/*------------------------------------------------------------------------------------
...
Choose Case	dwo.name
	...
	Case	"cb_hin_kijun"
		wf_button_clicked("$$HEX6$$fa57966ec154ee766a75f753$$ENDHEX$$")
		
	Case "cb_hin_seigen"
		wf_button_clicked("$$HEX6$$36525096c154ee766a75f753$$ENDHEX$$")
